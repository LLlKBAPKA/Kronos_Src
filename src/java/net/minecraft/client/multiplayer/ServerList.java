...
public class ServerList {
    ...
    public void loadServerList() {
        try {
            ...
            /*for (String sponsor : Excellent.inst().sponsors()) {
                ServerData autodob = new ServerData(TextFormatting.GRAY + sponsor.toUpperCase(), sponsor, false);
                autodob.setAutodob(true);
                this.servers.add(autodob);
            }*/
    ...
    public void saveServerList() {
        try {
            ...
            for (ServerData serverdata : this.servers) {
                if (serverdata.isAutodob()) continue;
